...
class Command(Base):
    ...
    action_type: Mapped[str] = mapped_column(String(128), nullable=True)
    target_resource_type: Mapped[str] = mapped_column(String(64), nullable=True)
    target_resource_id: Mapped[str] = mapped_column(String(36), nullable=True)
    ...
    confirmation_method: Mapped[str] = mapped_column(String(32), nullable=True)
    executed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=True)
    completed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=True)
    voice_session_id: Mapped[str] = mapped_column(String(36), nullable=True)
    transcript_id: Mapped[str] = mapped_column(String(36), nullable=True)
    latency_ms: Mapped[int] = mapped_column(Integer, nullable=True)
    provider_trace: Mapped[str] = mapped_column(Text, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
